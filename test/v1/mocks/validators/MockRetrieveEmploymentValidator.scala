...
class MockRetrieveEmploymentValidator extends MockFactory {

  val mockRetrieveCustomEmploymentValidator: RetrieveEmploymentValidator = mock[RetrieveEmploymentValidator]
