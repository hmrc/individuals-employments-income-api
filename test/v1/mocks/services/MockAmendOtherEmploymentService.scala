...
trait MockAmendOtherEmploymentService extends TestSuite with MockFactory {

  val mockAmendOtherEmploymentService: AmendOtherEmploymentService = mock[AmendOtherEmploymentService]

  object MockAmendOtherEmploymentService {

    def amend(requestData: AmendOtherEmploymentRequest): CallHandler[Future[ServiceOutcome[Unit]]] = {
