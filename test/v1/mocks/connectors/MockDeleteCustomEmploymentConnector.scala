...
trait MockDeleteCustomEmploymentConnector extends TestSuite with MockFactory {

  val mockDeleteCustomEmploymentConnector: DeleteCustomEmploymentConnector = mock[DeleteCustomEmploymentConnector]
