...
trait MockDeleteCustomEmploymentRequestParser extends MockFactory {

  val mockDeleteCustomEmploymentRequestParser: DeleteCustomEmploymentRequestParser = mock[DeleteCustomEmploymentRequestParser]
