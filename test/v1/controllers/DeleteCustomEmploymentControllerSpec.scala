...
class DeleteCustomEmploymentControllerSpec
  ...
  trait Test extends ControllerTest with AuditEventChecking[GenericAuditDetail] {
    ...
    val controller: DeleteCustomEmploymentController = new DeleteCustomEmploymentController(
    ...
    protected def callController(): Future[Result] = controller.deleteCustomEmployment(validNino, taxYear, employmentId)(
