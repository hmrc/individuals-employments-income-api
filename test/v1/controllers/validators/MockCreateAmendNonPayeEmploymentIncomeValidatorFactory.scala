...
trait MockCreateAmendNonPayeEmploymentIncomeValidatorFactory extends MockValidatorFactory[CreateAmendNonPayeEmploymentRequest] {
  ...
  val mockCreateAmendNonPayeEmploymentIncomeValidatorFactory: CreateAmendNonPayeEmploymentIncomeValidatorFactory =
    mock[CreateAmendNonPayeEmploymentIncomeValidatorFactory]

  def validator(): CallHandler[Validator[CreateAmendNonPayeEmploymentRequest]] =
    (mockCreateAmendNonPayeEmploymentIncomeValidatorFactory
