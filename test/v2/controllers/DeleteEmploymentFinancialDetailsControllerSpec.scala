...
import v2.controllers.validators.MockDeleteFinancialDetailsValidatorFactory
import v2.mocks.services.MockDeleteEmploymentFinancialDetailsService
...
class DeleteEmploymentFinancialDetailsControllerSpec
  ...
  trait Test extends ControllerTest with AuditEventChecking[GenericAuditDetail] {
    ...
    val controller: DeleteEmploymentFinancialDetailsController = new DeleteEmploymentFinancialDetailsController(
