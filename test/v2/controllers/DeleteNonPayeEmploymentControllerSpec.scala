...
import v2.controllers.validators.MockDeleteNonPayeEmploymentIncomeValidatorFactory
import v2.mocks.services.MockDeleteNonPayeEmploymentService
...
class DeleteNonPayeEmploymentControllerSpec
  ...
  trait Test extends ControllerTest with AuditEventChecking[GenericAuditDetail] {
    ...
    val controller: DeleteNonPayeEmploymentController = new DeleteNonPayeEmploymentController(
