...
class AmendRedundancyCompensationPaymentsOverExemptionItemSpec extends UnitSpec {
  ...
  "AmendRedundancyCompensationPaymentsOverExemptionItem" when {
    "read from valid JSON" should {
      "produce the expected AmendRedundancyCompensationPaymentsOverExemptionItem object" in {
        json.as[AmendRedundancyCompensationPaymentsOverExemptionItem] shouldBe model
      }
    }
    ...
    "read from empty JSON" should {
      "produce a JsError" in {
        ...
        invalidJson.validate[AmendRedundancyCompensationPaymentsOverExemptionItem] shouldBe a[JsError]
      }
    }
