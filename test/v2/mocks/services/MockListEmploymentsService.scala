...
import v2.services.ListEmploymentsService

import scala.concurrent.{ExecutionContext, Future}

trait MockListEmploymentsService extends TestSuite with MockFactory {

  val mockListEmploymentsService: ListEmploymentsService = mock[ListEmploymentsService]

  object MockListEmploymentsService {

    def listEmployments(requestData: ListEmploymentsRequest): CallHandler[Future[ServiceOutcome[ListEmploymentResponse]]] = {
