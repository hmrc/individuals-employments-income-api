...
trait MockRetrieveEmploymentAndFinancialDetailsConnector extends TestSuite with MockFactory {

  val mockConnector: RetrieveEmploymentAndFinancialDetailsConnector = mock[RetrieveEmploymentAndFinancialDetailsConnector]
