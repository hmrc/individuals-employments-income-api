...
import v2.connectors.AddCustomEmploymentConnector
...
trait MockAddCustomEmploymentConnector extends TestSuite with MockFactory {

  val mockAddCustomEmploymentConnector: AddCustomEmploymentConnector = mock[AddCustomEmploymentConnector]
