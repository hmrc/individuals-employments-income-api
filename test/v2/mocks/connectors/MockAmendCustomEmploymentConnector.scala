...
import v2.connectors.AmendCustomEmploymentConnector
import v2.models.request.amendCustomEmployment.AmendCustomEmploymentRequest

import scala.concurrent.{ExecutionContext, Future}

trait MockAmendCustomEmploymentConnector extends TestSuite with MockFactory {

  val mockAmendCustomEmploymentConnector: AmendCustomEmploymentConnector = mock[AmendCustomEmploymentConnector]
