...
class DeleteOtherEmploymentValidator(nino: String, taxYear: String, appConfig: EmploymentsAppConfig)
  ...
  override def validate: Validated[Seq[MtdError], DeleteOtherEmploymentIncomeRequest] =
    (
      ResolveNino(nino),
